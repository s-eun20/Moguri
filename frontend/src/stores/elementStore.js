...
export const useElementStore = defineStore('element', () => {
  ...
  const resultExplanation = computed(() => {
    switch(resultType.value) {
      ...
      열정적이고 적극적인 투자 성향을 가지고 있습니다. 금속이나 기계 업종에 유리하며, 불이 금속을 녹이는 것 처럼 혁신적이고 변동성이 있는 분야에서 성과를 낼 수 있습니다.`;   
         
      case '수':
        return `당신의 자산 관리 유형은 물입니다.   
      유연하고 신중한 투자 성향을 가지고 있습니다. 현금 흐름을 발생시키는 업종에서 유리, 조명, 광고 등에서 성공할 가능성이 큽니다.`;
      case '금':
      return `당신의 자산 관리 유형은 금입니다. 
      강하고 결단력있는 투자 성향을 가지고 있습니다. 효율적이고 구조적인 접근을 선호하며, 조경이나 출판 등에서 재물운이 강합니다. 안정성을 추구하는 투자 성향을 갖고 있습니다.`;
